...
@endif
        <form method="post" action="{{ route('campground-front.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input id="lat" type="text" name="lat" placeholder="Enter latitude"  class="form-control" pattern="\d+(\.\d{6})?" title="Must have 6 decimal places">
                @error('lat')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input id="lng" type="text" name="lng" placeholder="Enter longitude"  class="form-control" pattern="\d+(\.\d{6})?" title="Must have 6 decimal places">
                @error('lng')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
