...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        ...
        <a href="{{ route('campground.create') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add Campground"><i class="fas fa-plus"></i> Add Campground</a>
    </div>
    <div class="card-body">
                    ...
                    <tbody>
                        @foreach($campgrounds as $campground)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('campground.edit', $campground->id) }}" class="btn btn-primary btn-sm float-left mr-1" style="height: 30px; width: 30px; border-radius: 50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                    <form method="POST" action="{{ route('campground.destroy', [$campground->id]) }}">
                                        @csrf
                                        @method('delete')
